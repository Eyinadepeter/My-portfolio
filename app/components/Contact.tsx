...
const ContactCard = ({
  ...
  const colors = {
    indigo:
      "from-indigo-500/20 to-indigo-500/5 border-indigo-500/30 hover:border-indigo-500/50",
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 items-center">
          <ContactCard
            icon={Mail}
            title="Email"
            content="eyinadepeter2@gmail.com"
            link="mailto:eyinadepeter2@gmail.com"
            delay={0.1}
            color="indigo"
          />
          ...
          <ContactCard
            icon={Phone}
            title="Phone"
            content="+234 - 9071289110"
            link="tel:+2349071289110"
            delay={0.2}
            color="blue"
          />
          ...
          <ContactCard
            icon={MapPin}
            title="Location"
            content="Ota, Ogun State, Nigeria"
            link="#"
            delay={0.3}
            color="purple"
          />
