  ...
  const skills = [
    {
      ...
      technologies: "HTML, CSS, JavaScript, React.js, NextJs, Tailwindcss, UI",
      description:
        "Building modern, responsive user interfaces with NextJs and core front-end technologies.",
      color: "blue",
    },
    {
      icon: Server,
      ...
      technologies: "PHP",
      description:
        "Developing scalable back-end solutions with PHP programming languages.",
      color: "green",
    },
    {
      icon: Layers,
      ...
      technologies:
        "TailwindCss, Next.js,Chakra UI, Material UI (MUI),Shadcn/UI  ",
      description:
    ...
    },
    {
      ...
      technologies: "MySQL",
      description:
        "Efficient database design and management for optimal data handling.",
      color: "teal",
    },
    // {
    //   icon: Network,
    //   title: "RESTful API Development",
    //   technologies: "REST API, JSON, Fetch",
    //   description:
    ...
    // },
    {
      icon: PencilRuler,
      title: "Design Tools",
      technologies: " CorelDraw, Photoshop , Canva, Figma",
      description:
