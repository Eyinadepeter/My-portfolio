  ...
  const skills = [
    {
      ...
      title: "Frontend",
      description: "HTML, CSS, JavaScript, React.js, Nextjs ,Tailwind CSS.",
    },
    {
    ...
    // },
    {
      ...
      title: "AI/Tech",
      description:
        "Machine Learning, Deep Learning, Data Engineer, ICT Support",
    },
    // {
    ...
    // },
    {
      ...
      title: "Other",
      description: "Graphic Designer, Cloud Computing, DickJoker(DJ)",
    },
  ];
          ...
          >
            <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-indigo-500/20">
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="p-2 rounded-full bg-indigo-500/20 mb-2">
                  <Brain className="w-6 h-6 text-indigo-400" />
                </div>

                <h3 className="text-2xl font-bold text-white font-display text-center">
                  Full-Stack Developer & ICT- Support
                </h3>
              </div>

              <p className="text-xl text-slate-300 leading-relaxed mb-6">
                I am a web developer tech enthusiastic and have completed Some
                projects in Web Development and worked on frontend development
                using React, Nextjs , tailwindCss e.t.c. Also I have some
                knowledge about Php and mysql. ICT Support. To me, learning new
                things keeps me on going. I thrive on turning ideas into
                polished, functional solutions. Eager to learn and adapt,
              </p>
